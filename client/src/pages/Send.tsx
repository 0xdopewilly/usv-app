          ...
          >
            <Card className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 border-purple-500/20 p-6">
              <div className="text-center mb-6">
                <img src="/attached_assets/image_1757432548673.png" alt="USV" className="w-16 h-16 rounded-xl object-contain mx-auto mb-4" />
        ...
        >
          ...
          <Card className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 border-purple-500/20 p-6">
            <div className="flex items-center space-x-3 mb-4">
              <img src="/attached_assets/image_1757432548673.png" alt="USV" className="w-10 h-10 rounded-xl object-contain" />
              <div>
