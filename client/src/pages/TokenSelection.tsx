                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        {token.symbol === 'USV' ? (
                          ...
                          <div className="w-12 h-12 rounded-full bg-black flex items-center justify-center p-1.5">
                            <svg viewBox="0 0 100 100" className="w-full h-full">
                              ...
                              <path d="M20 70 L85 70 L80 77 L15 77 Z" fill="url(#solGrad1)" transform="skewY(-10)"/>
                              <path d="M20 50 L85 50 L80 57 L15 57 Z" fill="url(#solGrad1)" transform="skewY(-10)"/>
                              <path d="M20 30 L85 30 L80 37 L15 37 Z" fill="url(#solGrad1)" transform="skewY(-10)"/>
                            </svg>
                          </div>
                        ) : (
