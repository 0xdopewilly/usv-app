            ...
            >
              {passcode.length > index && (
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className={`w-3 h-3 rounded-full ${error ? 'bg-red-500' : 'bg-purple-500'}`}
                />
              )}
            </motion.div>
          ))}
        ...
        <div className="grid grid-cols-3 gap-3">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((digit) => (
            <button
              ...
              className="h-16 bg-gray-800/50 hover:bg-gray-700/50 text-white text-2xl font-semibold rounded-[20px] transition-colors disabled:opacity-50"
          ...
          <button
            ...
            disabled={isVerifying}
            className="h-16 bg-gray-800/50 hover:bg-gray-700/50 text-white text-sm rounded-[20px] transition-colors disabled:opacity-50"
